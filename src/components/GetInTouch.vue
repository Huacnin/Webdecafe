  ...
  >
    ...
    >
      ...
      <v-col
        ...
        md="4"
      >
        <base-bubble-1 style="transform: rotate(360deg) translate(290px,-15%)"/>

        <base-heading class="mb-10 ml-10">
          Envíe su Mensaje:
        </base-heading>
  ...
  export default {
    ...
    data: () => ({
      ...
      from_telefonoRules: [
        ...
        v => (v && v.length > 8) || 'El nombre debe ser mayor a 8 caracteres',
      ],
      subject: '',
      subjectRules: [
    ...
    created () {
      emailjs.init('user_dn1I2UGYFTxjP4cTcISNx')
    },
    ...
    methods: {
      submit () {
        ...
        if (this.$refs.form.validate()) {
          emailjs.send('gmail', 'decafeymas', data)
